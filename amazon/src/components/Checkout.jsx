    ...
    <div className="h-screen ">
      <div className="min-w-[1000px] max-w-[1500px] m-auto pt-8">
        <div className="grid grid-cols-8 gap-10">
                  ...
                  <div className="grid grid-cols-12 divide-y divide-gray-400 mr-4">
                    <div className="col-span-10 grid grid-cols-8 divide-y divide-gray-400">
                      ...
                      <div className="col-span-6">
                        ...
                        <div>
                          <button
                            className="bg-red-500  p-3 text-xs xl:text-sm rounded hover:bg-red-700 hover:text-white  mt-3 mb-3 cursor-pointer"
                            onClick={() => dispatch(removeFromCart(product.id))}
                          >
                            Delete
                          </button>
                        </div>
                        <div className="grid grid-cols-3 w-20 text-center mb-3">
                          <div
          ...
          {/* Checkout */}
          <div className="col-span-2 bg-gray-300 rounded h-[250px] p-7">
            ...
            <button className="btn font-bold">Proceed to Checkout</button>
          </div>
        </div>
      </div>
    </div>
